...
# Mountable Removable Media (e.g. USB/SD device) Blocking

Mountable Removable Media blocking allows blocking removable media such as USB Mass Storage/SD Card storage from mounting, or
