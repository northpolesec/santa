...
+ (NSString*)longHelpText {
  return [NSString
      stringWithFormat:
          ...
          @"    --key {key}: Search and return this one piece of information.\n"
          @"           You may specify multiple keys by repeating this flag.\n"
          @"           Valid Keys:\n"
          @"%@\n"
          @"           Valid keys when using --cert-index:\n"
          @"%@\n"
          @"    --cert-index {index}: Supply an integer corresponding to a certificate of the\n"
          ...
          @"    --filter {key=regex}: Use predicates of the form 'key=regex' to filter out which "
          @"files\n"
