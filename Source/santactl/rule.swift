...
extension Santactl {
  struct Rule: ParsableCommand {
    ...
    @Option(name: .customLong("import"), help: "The path to the rule file to import. Use '-' for stdin.")
    var importPath: String?

    @Option(name: .customLong("export"), help: "The path to the rule file to export. Use '-' for stdout.")
