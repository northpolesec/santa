...
#ifndef SANTA_SANTAD_LOGS_ENDPOINTSECURITY_SERIALIZERS_EMPTY_H
#define SANTA_SANTAD_LOGS_ENDPOINTSECURITY_SERIALIZERS_EMPTY_H
...
#endif  // SANTA_SANTAD_LOGS_ENDPOINTSECURITY_SERIALIZERS_EMPTY_H
