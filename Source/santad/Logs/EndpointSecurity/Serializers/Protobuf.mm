...
::pbv1::Execution::Reason GetReasonEnum(SNTEventState event_state) {
  switch (event_state) {
    ...
    case SNTEventStateAllowCELFallback: return ::pbv1::Execution::REASON_UNKNOWN;
    ...
    case SNTEventStateBlockCELFallback: return ::pbv1::Execution::REASON_UNKNOWN;
...
static void EncodeDisk(::pbv1::Disk *pb_disk, ::pbv1::Disk_Action action, NSDictionary *props,
  ...
  EncodeString([pb_disk] { return pb_disk->mutable_model(); }, model.length > 0 ? model : nil);
