...
/// A process descriptor shared by stored events that need rich, recursive
/// process identity (file access, network flow).
@interface SNTStoredProcess : NSObject <NSSecureCoding>
...
@property(nullable) SNTStoredProcess* parent;
