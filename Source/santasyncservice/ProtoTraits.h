...
struct ProtoTraits<std::bool_constant<false>> {
  ...
  static constexpr ClientMode UNKNOWN_CLIENT_MODE =
      ::santa::sync::v1::UNKNOWN_CLIENT_MODE;
  ...
  static constexpr Decision DECISION_UNKNOWN =
      ::santa::sync::v1::DECISION_UNKNOWN;
  ...
  static constexpr Decision ALLOW_CERTIFICATE =
      ::santa::sync::v1::ALLOW_CERTIFICATE;
  ...
  static constexpr Decision ALLOW_SIGNINGID =
      ::santa::sync::v1::ALLOW_SIGNINGID;
  ...
  static constexpr Decision BLOCK_CERTIFICATE =
      ::santa::sync::v1::BLOCK_CERTIFICATE;
  ...
  static constexpr Decision BLOCK_SIGNINGID =
      ::santa::sync::v1::BLOCK_SIGNINGID;
  ...
  static constexpr FileAccessAction FILE_ACCESS_ACTION_UNSPECIFIED =
      ::santa::sync::v1::FILE_ACCESS_ACTION_UNSPECIFIED;
  ...
  static constexpr FileAccessDecision FILE_ACCESS_DECISION_UNKNOWN =
      ::santa::sync::v1::FILE_ACCESS_DECISION_UNKNOWN;
  static constexpr FileAccessDecision FILE_ACCESS_DECISION_DENIED =
      ::santa::sync::v1::FILE_ACCESS_DECISION_DENIED;
  static constexpr FileAccessDecision
      FILE_ACCESS_DECISION_DENIED_INVALID_SIGNATURE =
          ::santa::sync::v1::FILE_ACCESS_DECISION_DENIED_INVALID_SIGNATURE;
  static constexpr FileAccessDecision FILE_ACCESS_DECISION_AUDIT_ONLY =
      ::santa::sync::v1::FILE_ACCESS_DECISION_AUDIT_ONLY;
  ...
  static constexpr Policy ALLOWLIST_COMPILER =
      ::santa::sync::v1::ALLOWLIST_COMPILER;
  static constexpr Policy BLOCKLIST = ::santa::sync::v1::BLOCKLIST;
  static constexpr Policy SILENT_BLOCKLIST =
      ::santa::sync::v1::SILENT_BLOCKLIST;
  ...
  static constexpr RuleType RULETYPE_UNKNOWN =
      ::santa::sync::v1::RULETYPE_UNKNOWN;
  ...
  static constexpr SigningStatus SIGNING_STATUS_UNSPECIFIED =
      ::santa::sync::v1::SIGNING_STATUS_UNSPECIFIED;
  static constexpr SigningStatus SIGNING_STATUS_UNSIGNED =
      ::santa::sync::v1::SIGNING_STATUS_UNSIGNED;
  static constexpr SigningStatus SIGNING_STATUS_INVALID =
      ::santa::sync::v1::SIGNING_STATUS_INVALID;
  static constexpr SigningStatus SIGNING_STATUS_ADHOC =
      ::santa::sync::v1::SIGNING_STATUS_ADHOC;
  static constexpr SigningStatus SIGNING_STATUS_DEVELOPMENT =
      ::santa::sync::v1::SIGNING_STATUS_DEVELOPMENT;
  static constexpr SigningStatus SIGNING_STATUS_PRODUCTION =
      ::santa::sync::v1::SIGNING_STATUS_PRODUCTION;

  using SyncType = ::santa::sync::v1::SyncType;
  static constexpr SyncType SYNC_TYPE_UNSPECIFIED =
      ::santa::sync::v1::SYNC_TYPE_UNSPECIFIED;
  ...
  static constexpr SyncType CLEAN_STANDALONE =
      ::santa::sync::v1::CLEAN_STANDALONE;
  static constexpr SyncType CLEAN_RULES = ::santa::sync::v1::CLEAN_RULES;
  static constexpr SyncType CLEAN_FILE_ACCESS_RULES =
      ::santa::sync::v1::CLEAN_FILE_ACCESS_RULES;
};
...
struct ProtoTraits<std::bool_constant<true>> {
  ...
  static constexpr ClientMode UNKNOWN_CLIENT_MODE =
      ::santa::sync::v2::UNKNOWN_CLIENT_MODE;
  ...
  static constexpr Decision DECISION_UNKNOWN =
      ::santa::sync::v2::DECISION_UNKNOWN;
  ...
  static constexpr Decision ALLOW_CERTIFICATE =
      ::santa::sync::v2::ALLOW_CERTIFICATE;
  ...
  static constexpr Decision BLOCK_CERTIFICATE =
      ::santa::sync::v2::BLOCK_CERTIFICATE;
  ...
  static constexpr FileAccessAction FILE_ACCESS_ACTION_UNSPECIFIED =
      ::santa::sync::v2::FILE_ACCESS_ACTION_UNSPECIFIED;
  ...
  static constexpr FileAccessDecision FILE_ACCESS_DECISION_UNKNOWN =
      ::santa::sync::v2::FILE_ACCESS_DECISION_UNKNOWN;
  static constexpr FileAccessDecision FILE_ACCESS_DECISION_DENIED =
      ::santa::sync::v2::FILE_ACCESS_DECISION_DENIED;
  static constexpr FileAccessDecision
      FILE_ACCESS_DECISION_DENIED_INVALID_SIGNATURE =
          ::santa::sync::v2::FILE_ACCESS_DECISION_DENIED_INVALID_SIGNATURE;
  static constexpr FileAccessDecision FILE_ACCESS_DECISION_AUDIT_ONLY =
      ::santa::sync::v2::FILE_ACCESS_DECISION_AUDIT_ONLY;
  ...
  static constexpr Policy ALLOWLIST_COMPILER =
      ::santa::sync::v2::ALLOWLIST_COMPILER;
  static constexpr Policy BLOCKLIST = ::santa::sync::v2::BLOCKLIST;
  static constexpr Policy SILENT_BLOCKLIST =
      ::santa::sync::v2::SILENT_BLOCKLIST;
  ...
  static constexpr RuleType RULETYPE_UNKNOWN =
      ::santa::sync::v2::RULETYPE_UNKNOWN;
  ...
  static constexpr SigningStatus SIGNING_STATUS_UNSPECIFIED =
      ::santa::sync::v2::SIGNING_STATUS_UNSPECIFIED;
  static constexpr SigningStatus SIGNING_STATUS_UNSIGNED =
      ::santa::sync::v2::SIGNING_STATUS_UNSIGNED;
  static constexpr SigningStatus SIGNING_STATUS_INVALID =
      ::santa::sync::v2::SIGNING_STATUS_INVALID;
  static constexpr SigningStatus SIGNING_STATUS_ADHOC =
      ::santa::sync::v2::SIGNING_STATUS_ADHOC;
  static constexpr SigningStatus SIGNING_STATUS_DEVELOPMENT =
      ::santa::sync::v2::SIGNING_STATUS_DEVELOPMENT;
  static constexpr SigningStatus SIGNING_STATUS_PRODUCTION =
      ::santa::sync::v2::SIGNING_STATUS_PRODUCTION;

  using SyncType = ::santa::sync::v2::SyncType;
  static constexpr SyncType SYNC_TYPE_UNSPECIFIED =
      ::santa::sync::v2::SYNC_TYPE_UNSPECIFIED;
  ...
  static constexpr SyncType CLEAN_STANDALONE =
      ::santa::sync::v2::CLEAN_STANDALONE;
  static constexpr SyncType CLEAN_RULES = ::santa::sync::v2::CLEAN_RULES;
  static constexpr SyncType CLEAN_FILE_ACCESS_RULES =
      ::santa::sync::v2::CLEAN_FILE_ACCESS_RULES;
};
