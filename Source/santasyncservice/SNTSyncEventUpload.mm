...
typename santa::ProtoTraits<IsV2>::EventT *MessageForExecutionEvent(
  ...
  switch (event.decision) {
    ...
    case SNTEventStateBlockCELFallback: e->set_decision(Traits::BLOCK_UNKNOWN); break;
    case SNTEventStateAllowCELFallback: e->set_decision(Traits::ALLOW_UNKNOWN); break;
