...
#include "src/santad/SantadDeps.h"
...
#include "src/santad/process_tree/annotations/originator.h"
...
#include "src/santad/SNTPolicyProcessor.h"
...
std::unique_ptr<SantadDeps> SantadDeps::Create(SNTConfigurator *configurator,
  ...
  // 2. Rules embedded in the Santa configuration
